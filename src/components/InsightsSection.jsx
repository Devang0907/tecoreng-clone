        ...
        <section className="items-center h-[1000px] px-4 bg-[#01132e] text-white">
            <div className="max-w-[1200px] mx-auto">
                ...
                >
                    <Draggable
                        axis="x"
                        bounds={{ left: -((insights.length - slidesToShow) * slideWidth), right: 0 }}
                        onStop={handleDragStop}
                    >
                        <div ref={carouselRef} className="flex mt-5 h-full space-x-4 transition-transform duration-500 ease-in-out">
