...
const FormSection = () => {
    ...
    return (
        <section className="flex bg-[#03142e] px-15 min-h-screen bg-navy-900">

            {/* Left Section */}

            <div className="w-1/2 p-6 ml-[35px] text-white">
            ...
            <div className="w-1/2 p-12">
                <div className="bg-white rounded-[40px] p-8 w-[500px]">
                    <h2 className="text-[55px] font-[500] mb-2">Get in <span className="bg-gradient-to-r from-[rgb(255,97,11)] via-[rgb(255,140,60)] to-[rgb(252,183,162)] bg-clip-text text-transparent">touch</span></h2>
                    <p className="text-[16px] font-medium text-black mb-6 leading-[21px]">
