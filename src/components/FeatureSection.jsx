...
function FeatureSection() {
    ...
    const features_with_images = [
        {
            imageUrl: "/images/s-1.webp", 
            title: 'Reporting & Analysis',
        },
        {
            imageUrl: "/images/s-2.webp", 
            title: 'On-Time Delivery',
        },
        {
            imageUrl: "/images/s-3.webp", 
            title: 'Seamless Communication',
        },
        {
            imageUrl: "/images/s-4.webp", 
    ...
    return (
        <section className="items-center px-30 py-10 bg-[#112542] text-white">
            <div className="container">
                <h2 className="container p-0 text-[50px] tracking-[5px] leading-[1.2] uppercase" style={{
                    "-webkit-text-stroke": "1px white",
                    color: "transparent"
                }}>
                    Why Tecoreng for your next project
                </h2>
                <p className="text-md pt-8 font-normal">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 pt-15">
                    {features_with_images.map((feature, index) => (
                        <div
                            key={index}
                            className="h-[130px] rounded-[17px] bg-[#112542] p-6 flex flex-col items-center justify-center text-center border border-transparent shadow-lg" style={{"box-shadow": "rgb(1, 19, 46) 0px 12px 17px" , "background": "linear-gradient(rgb(17, 37, 66), rgb(17, 37, 66)) padding-box padding-box, linear-gradient(rgba(255, 255, 255, 0.58) 0px, rgba(1, 19, 46, 0) 100%) border-box border-box"}}
                        >
                            <div className="mb-4">
                                <img
                    ...
                    {features_text.map((feature, index) => (
                        <div
                            key={index}
                            className="h-[130px] mt-8 rounded-[17px] bg-[#112542] p-6 flex flex-col items-center justify-center text-center border border-transparent shadow-lg" style={{"box-shadow": "rgb(1, 19, 46) 0px 12px 17px" , "background": "linear-gradient(rgb(17, 37, 66), rgb(17, 37, 66)) padding-box padding-box, linear-gradient(rgba(255, 255, 255, 0.58) 0px, rgba(1, 19, 46, 0) 100%) border-box border-box"}}
                        >
