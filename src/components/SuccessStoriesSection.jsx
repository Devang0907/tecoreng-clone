    ...
    const stories = [
        {
            ...
            img_url: "/images/pi-1.webp",
            video_url:"/video/pv-1.mp4"
        },
        {
            ...
            img_url: "/images/pi-2.webp",
            video_url:"/video/pv-2.mp4"
        },
        {
            title: 'An E - Commerce',
            ...
            img_url: "/images/pi-3.webp",
            video_url:"/video/pv-3.mp4"
        }
    ];
    return (
        <section className="items-center h-auto md:h-[670px] px-5 md:px-30 bg-[#01132e] text-white">
            <div className="container pt-10">
                <h2 className="text-3xl md:text-5xl leading-[54px] md:leading-[84px] text-shadow text-shadow-custom text-center md:text-left">
                    Our Success Stories
                </h2>
